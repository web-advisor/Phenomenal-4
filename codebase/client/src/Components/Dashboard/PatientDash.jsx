...
function PatientDash() {
  ...
  useEffect(() => {
    let url = `https://phenomenal-doctors.onrender.com/admin/manage/doctor/delete/${card.slug}`
 ...
 useEffect(() => {
  let url = `https://phenomenal-doctors.onrender.com/data/doctors/nearby?address=${address}`
